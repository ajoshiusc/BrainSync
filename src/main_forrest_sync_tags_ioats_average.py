...
#fseg2 = fseg2[ind, :]
    ...
    faceseg1_2_avg += faceseg1_2

plt.plot(faceseg1, 'b')
plt.plot(faceseg2, 'r')
plt.plot(faceseg1_2_avg/5, 'k')
#faceseg1_2_avg=normdata(faceseg1_2_avg)
#faceseg1=normdata(faceseg1)
#faceseg2=normdata(faceseg2)

print(sp.linalg.norm(fseg1-fseg2), sp.linalg.norm(fseg1_2-fseg2), sp.linalg.norm(fseg1_2-fseg1))
print(sp.dot(faceseg1,faceseg2)/len(faceseg2), sp.dot(faceseg1_2_avg,faceseg2)/len(faceseg2), sp.dot(faceseg1_2,faceseg1)/len(faceseg2))

faceseg1_2_avg=faceseg1_2_avg/sp.linalg.norm(faceseg1_2_avg)
faceseg1=faceseg1/sp.linalg.norm(faceseg1)
faceseg2=faceseg2/sp.linalg.norm(faceseg2)
print(sp.dot(faceseg1,faceseg2), sp.dot(faceseg1_2_avg,faceseg2), sp.dot(faceseg1_2_avg,faceseg1))
