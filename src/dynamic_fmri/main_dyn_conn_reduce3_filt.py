...
refdata = spio.loadmat(os.path.join(p_dir, ref, ref + '.rfMRI_REST1_LR.reduce3.ftdata.NLM_11N_hvar_25.mat'))

dr = refdata['ftdata_NLM'].T
meanData = 0
NSUB = len(lst)
...
task = spio.loadmat('/big_disk/ajoshi/with_andrew/100307/100307.tfMRI_MOTOR_LR.reduce3.ftdata.NLM_11N_hvar_25.mat')
...
np.savez('motor_diff_data_filt.npz', diffafter=diffafter)

spio.savemat('motor_diff_data_filt.mat',{'diffafter':diffafter})
